...
// ============================================================
// ✅ SEO NOTE:
// All SEO metadata (title, description, og, twitter, robots,
// canonical) for this page is handled in [slug]/page.jsx via
// generateMetadata(). Do NOT add <title> or <meta> tags here —
// this is a Client Component ('use client') and any meta tags
// placed here render inside <body>, NOT <head>, and are
    ...
    {({ status, dragActive, fileQueue, acceptedFiles, compressionLevel, setCompressionLevel,
      ...
      return (
        <div className="min-h-screen bg-[#F8FAFC] flex flex-col font-sans">
          ...
          {/* ✅ SEO Content — H1 + subtitle visible to Google crawler */}
          <Header />
          ...
          <main className="flex-1 flex flex-col items-center justify-start pt-6 md:pt-8 px-4 md:px-6">
            ...
            {(status === 'uploading' || status === 'processing') && (
              <div className="bg-white p-8 md:p-16 rounded-[3rem] shadow-2xl border border-gray-50 text-center w-full max-w-lg animate-in zoom-in-95 duration-300">
                ...
                <p className="text-gray-400 font-medium text-sm mb-8 truncate px-4">
                  {fileQueue[0]?.name}
                </p>
