  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col font-sans">
      ...
      <main className="flex-1 flex flex-col items-center justify-start pt-6 md:pt-10 px-4 md:px-6">
        ...
        {/* ── PROCESSING ── */}
        {status === 'processing' && (
          <div className="bg-white p-16 mb-5 rounded-[3rem] shadow-2xl text-center w-full max-w-lg">
        ...
        {/* ── ERROR ── */}
        {status === 'error' && (
          <div className="bg-white p-12 mb-10 rounded-[2.5rem] shadow-2xl text-center w-full max-w-lg">
