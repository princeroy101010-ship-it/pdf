...
const jsonLd = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://www.freepdfconvert.io/text-to-word",
      "url": "https://www.freepdfconvert.io/text-to-word",
      "name": "Text to Word Converter – Free Online TXT to DOCX | FreePDFConvert",
      "description": "Convert text to Word (DOCX) online for free. No installation, no sign-up required. Turn any TXT file into an editable Word document in seconds — fast, secure & 100% free.",
      "isPartOf": { "@id": "https://www.freepdfconvert.io/#website" },
      "about": { "@id": "https://www.freepdfconvert.io/text-to-word/#software" },
      "breadcrumb": {
        "@type": "BreadcrumbList",
        "itemListElement": [
          { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://www.freepdfconvert.io/" },
          { "@type": "ListItem", "position": 2, "name": "Text to Word", "item": "https://www.freepdfconvert.io/text-to-word" }
        ]
      }
    },
    {
      "@type": "SoftwareApplication",
      "@id": "https://www.freepdfconvert.io/text-to-word/#software",
      ...
      "featureList": [
        "Convert TXT to DOCX free",
        "No registration required",
        "Instant Word document download",
    ...
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How do I convert text to Word for free?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Upload your .txt file on FreePDFConvert.io, click Convert, and download your editable Word DOCX document instantly — completely free with no sign-up required."
          }
        },
        {
          "@type": "Question",
          "name": "Can I convert a TXT file to DOCX online?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes! FreePDFConvert lets you convert any plain text or .txt file into a fully editable Word DOCX document online, right in your browser — no software installation needed."
          }
        },
        {
          "@type": "Question",
          "name": "Will the Word file have a watermark?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No. FreePDFConvert generates clean Word DOCX files with absolutely no watermarks, logos, or branding added to your document."
          }
        },
        {
          "@type": "Question",
          "name": "Is FreePDFConvert safe for text to Word conversion?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. All file transfers use HTTPS encryption. Your text files are permanently deleted from our servers immediately after conversion. We never store or share your content."
          }
        },
        {
          "@type": "Question",
          "name": "Can I edit the Word file after converting from text?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Absolutely. The output is a fully editable .docx file that you can open and edit in Microsoft Word, Google Docs, LibreOffice Writer, and all major word processors."
          }
        },
        {
          "@type": "Question",
          "name": "Is there a file size limit for text to Word conversion?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "FreePDFConvert supports large text files. You can convert .txt files to Word DOCX free with no restrictions on file size or number of daily conversions."
          }
        }
      ]
    },
    {
      "@type": "HowTo",
      "name": "How to Convert Text to Word Document Online",
      "description": "Convert any TXT file to a Word DOCX document in 3 simple steps using FreePDFConvert.",
      "step": [
        {
          "@type": "HowToStep",
          "position": "1",
        ...
        },
        {
          ...
          "text": "Our converter instantly processes your text and generates a fully editable Word DOCX document."
        },
        {
          "@type": "HowToStep",
          "position": "3",
          "name": "Download Your DOCX",
          "text": "Click Download Word File to save your document. No watermark. Your text file is deleted from our servers immediately after conversion."
        }
      ]
    },
    {
    ...
    {({ status, dragActive, fileQueue, acceptedFiles,
      ...
      return (
        <>
          ...
          <Head>
            {/* Primary Meta */}
            <title>Text to Word Converter Free Online TXT to DOCX</title>
            <meta name="description" content="Convert text to Word (DOCX) online free — no email, no install needed. Turn any TXT file into a fully editable Word document in seconds. No watermark. Fast, private & 100% free." />
            <meta name="keywords" content="text to word, txt to docx, convert text to word, text to word converter, txt to word, text file to docx, online text to word, free text to word, convert txt to word online, plain text to word document, notepad to word, text to docx converter" />
            <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
            <meta name="author" content="FreePDFConvert" />
            <meta name="viewport" content="width=device-width, initial-scale=1" />
            <link rel="canonical" href="https://www.freepdfconvert.io/text-to-word" />

            {/* Open Graph */}
            <meta property="og:type" content="website" />
            <meta property="og:site_name" content="FreePDFConvert" />
            <meta property="og:title" content="Text to Word Converter – Free Online TXT to DOCX | FreePDFConvert" />
            <meta property="og:description" content="Convert text to Word DOCX online free — no email, no install. Turn any TXT file into a fully editable Word document instantly. No watermark added." />
            <meta property="og:url" content="https://www.freepdfconvert.io/text-to-word" />
            <meta property="og:image" content="https://www.freepdfconvert.io/og-text-to-word.png" />
            <meta property="og:image:width" content="1200" />
            <meta property="og:image:height" content="630" />
            <meta property="og:image:alt" content="FreePDFConvert – Free Text to Word DOCX Converter" />
            <meta property="og:locale" content="en_US" />

            {/* Twitter Card */}
            <meta name="twitter:card" content="summary_large_image" />
            <meta name="twitter:site" content="@freepdfconvert" />
            <meta name="twitter:title" content="Text to Word Converter – Free Online TXT to DOCX | FreePDFConvert" />
            <meta name="twitter:description" content="Convert any TXT file to an editable Word DOCX online for free. No sign-up, no watermark, instant download." />
            <meta name="twitter:image" content="https://www.freepdfconvert.io/og-text-to-word.png" />
          ...
          <div className="min-h-screen bg-[#F8FAFC] flex flex-col font-sans">
            ...
            >
              ...
              {status === 'idle' && (
                ...
                >
                  <meta itemProp="name" content="Text to Word Converter" />
