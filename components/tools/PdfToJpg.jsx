...
const unifiedGraphSchema = {
  ...
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://freepdfconvert.io/pdf-to-jpg',
      ...
      about: { '@id': 'https://freepdfconvert.io/pdf-to-jpg/#software' },
      breadcrumb: { '@id': 'https://freepdfconvert.io/pdf-to-jpg/#breadcrumb' }
    },
    {
      '@type': 'BreadcrumbList',
      '@id': 'https://freepdfconvert.io/pdf-to-jpg/#breadcrumb',
      itemListElement: [
        { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://freepdfconvert.io/' },
        { '@type': 'ListItem', position: 2, name: 'PDF to JPG', item: 'https://freepdfconvert.io/pdf-to-jpg' }
      ]
    },
    {
      '@type': 'WebApplication',
      '@id': 'https://freepdfconvert.io/pdf-to-jpg/#software',
    ...
    {
      '@type': 'FAQPage',
      '@id': 'https://freepdfconvert.io/pdf-to-jpg/#faq',
