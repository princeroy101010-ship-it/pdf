  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Upload your PDF to FreePDFConvert's free PDF splitter, choose your split mode (by range, select pages, or every N pages), and click Split PDF. Download your files instantly. No signup required."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Use the 'Select Pages' mode to click on individual page thumbnails and extract only the pages you need into separate PDF files."
      }
    },
    {
      "@type": "Question",
      "name": "Is the PDF splitter free?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. FreePDFConvert's split PDF tool is completely free with no hidden fees, no subscription, and no account needed."
      }
    },
    {
      "@type": "Question",
      "name": "Will the split PDFs have a watermark?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. FreePDFConvert never adds watermarks to any split PDF files. All output files are always clean and professional."
      }
    },
    {
      "@type": "Question",
      "name": "How many ways can I split a PDF?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "FreePDFConvert offers 3 split modes: by page range (e.g. pages 1-5), by selecting individual pages visually, or by splitting every N pages automatically."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. All uploads use SSL encryption and files are automatically deleted after processing. Your data is never stored or shared."
      }
    }
  ]
};
...
const howToSchema = {
  ...
  "description": "Split or extract pages from any PDF in 3 simple steps using FreePDFConvert.",
  "step": [
    {
      "@type": "HowToStep",
      "position": 1,
    ...
    },
    {
      ...
      "text": "Select your preferred split mode: by page range, select individual pages, or split every N pages."
    },
    {
      "@type": "HowToStep",
      "position": 3,
      "name": "Download Split Files",
      "text": "Click Split PDF and download your individual PDF files instantly. No signup required."
    }
  ]
};
