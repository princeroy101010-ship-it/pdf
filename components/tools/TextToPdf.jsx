...
const jsonLd = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://freepdfconvert.io/text-to-pdf",
      "url": "https://freepdfconvert.io/text-to-pdf",
      "name": "Text to PDF Converter – Free Online Tool | FreePDFConvert",
      "description": "Convert text to PDF online for free. No installation, no sign-up required. Turn any TXT file into a professional PDF in seconds — fast, secure and 100% free.",
      "isPartOf": { "@id": "https://freepdfconvert.io/#website" },
      "about": { "@id": "https://freepdfconvert.io/text-to-pdf/#software" },
      "breadcrumb": {
        "@type": "BreadcrumbList",
        "itemListElement": [
          { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://freepdfconvert.io/" },
          { "@type": "ListItem", "position": 2, "name": "Text to PDF", "item": "https://freepdfconvert.io/text-to-pdf" }
        ]
      }
    },
    {
      "@type": "SoftwareApplication",
      "@id": "https://freepdfconvert.io/text-to-pdf/#software",
    ...
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How do I convert text to PDF for free?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Upload your .txt file on FreePDFConvert.io, click Convert, and download your PDF instantly — completely free with no sign-up required."
          }
        },
        {
          "@type": "Question",
          "name": "Can I convert a TXT file to PDF online?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes! FreePDFConvert lets you convert any .txt or plain text file to a professional PDF document online, right in your browser — no software needed."
          }
        },
        {
          "@type": "Question",
          "name": "Is FreePDFConvert safe to use for text to PDF conversion?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. All uploads are encrypted with HTTPS. Your text files are permanently deleted from our servers immediately after conversion. We never read or store your content."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No. FreePDFConvert generates clean PDF files with absolutely no watermarks, logos, or branding added to your document."
          }
        },
        {
          "@type": "Question",
          "name": "What devices support this text to PDF converter?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Our text to PDF tool works on all devices — Windows, Mac, Linux, iPhone, iPad, and Android — in any modern web browser. No installation required."
          }
        },
        {
          "@type": "Question",
          "name": "Is there a file size limit for text to PDF conversion?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "FreePDFConvert supports large text files. You can convert .txt files to PDF free with no restrictions on file size or number of conversions."
          }
        }
      ]
    },
    ...
    {({ status, dragActive, fileQueue, acceptedFiles,
      ...
      return (
        <>
          ...
          <Head>
            {/* Primary Meta */}
            <title>Text to PDF Converter – Free Online, No Sign-Up | FreePDFConvert</title>
            <meta name="description" content="Convert text to PDF online free — no email, no install needed. Turn any TXT file into a clean PDF in seconds. No watermark. Fast, private & 100% free." />
            <meta name="keywords" content="text to pdf, txt to pdf, convert text to pdf, text to pdf converter, txt to pdf converter, text file to pdf, online text to pdf, free text to pdf, convert txt to pdf online, plain text to pdf, notepad to pdf, text document to pdf" />
            <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
            <meta name="author" content="FreePDFConvert" />
            <meta name="viewport" content="width=device-width, initial-scale=1" />
            <link rel="canonical" href="https://freepdfconvert.io/text-to-pdf" />

            {/* Open Graph */}
            <meta property="og:type" content="website" />
            <meta property="og:site_name" content="FreePDFConvert" />
            <meta property="og:title" content="Text to PDF Converter – Free Online, No Sign-Up | FreePDFConvert" />
            <meta property="og:description" content="Convert text to PDF online free — no email, no install. Turn any TXT file into a clean PDF instantly. No watermark added." />
            <meta property="og:url" content="https://freepdfconvert.io/text-to-pdf" />
            <meta property="og:image" content="https://freepdfconvert.io/og-text-to-pdf.png" />
            <meta property="og:image:width" content="1200" />
            <meta property="og:image:height" content="630" />
            <meta property="og:image:alt" content="FreePDFConvert – Free Text to PDF Converter" />
            <meta property="og:locale" content="en_US" />

            {/* Twitter Card */}
            <meta name="twitter:card" content="summary_large_image" />
            <meta name="twitter:site" content="@freepdfconvert" />
            <meta name="twitter:title" content="Text to PDF Converter – Free Online | FreePDFConvert" />
            <meta name="twitter:description" content="Convert any TXT file to PDF online for free. No sign-up, no watermark, instant download." />
            <meta name="twitter:image" content="https://freepdfconvert.io/og-text-to-pdf.png" />
          ...
          <div className="min-h-screen bg-[#F8FAFC] flex flex-col font-sans">
            ...
            >
              ...
              {status === 'idle' && (
                ...
                >
                  <meta itemProp="name" content="Text to PDF Converter" />
                  ...
                  <header className="text-center mb-8 md:mb-12">
                    ...
                    >
                      Convert any text file to PDF online — free, instant, no sign-up required. Turn your TXT file into a clean PDF in seconds.
                    </p>
                  </header>
                  ...
                  >
                    ...
                    <div className="text-gray-500 text-sm space-y-3 leading-relaxed">
                      <p>
                        <strong className="text-gray-700">FreePDFConvert</strong> is the fastest way to <strong className="text-gray-700">convert text to PDF</strong> online, completely free and without registration. Whether you have a plain <strong className="text-gray-700">.txt file</strong>, a Notepad document, or any other plain text file, our <strong className="text-gray-700">text to PDF converter</strong> turns it into a clean, professional PDF in seconds.
                      </p>
                      <p>
                        Unlike other tools, our <strong className="text-gray-700">free TXT to PDF converter</strong> works entirely in your browser — no software download, no email required. The output PDF is completely watermark-free, making it perfect for professional use, sharing, or printing.
                      </p>
                      <p>
                        Need to <strong className="text-gray-700">convert a text file to PDF</strong> quickly? Simply upload your file, let our converter process it, and download your <strong className="text-gray-700">PDF file</strong> instantly. Your file is deleted from our servers immediately after conversion, making FreePDFConvert the most private <strong className="text-gray-700">online text to PDF tool</strong> available.
                      </p>
                    </div>
                  </section>
              ...
              {(status === 'uploading' || status === 'processing') && (
                <div
                  ...
                  role="status"
                  aria-live="polite"
                  aria-label={status === 'uploading' ? 'Uploading your text file' : 'Converting text to PDF'}
                >
              ...
              {status === 'completed' && (
                ...
                >
                  ...
                  <p className="text-gray-500 mb-6">Your text has been converted to PDF. Click below to download.</p>
