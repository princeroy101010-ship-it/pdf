...
import { Download, CheckCircle2, Upload, Loader2, Plus, ShieldCheck, Eye, EyeOff, Lock, X, Settings } from 'lucide-react';
          ...
          <main className="flex-1 flex flex-col items-center justify-start pt-6 md:pt-8 px-4 md:px-6">
                ...
                {fileQueue.length > 0 && (
                  <div className="w-full max-w-2xl animate-in slide-in-from-top-4 space-y-4 mb-8">
                    ...
                    <div className="p-5 md:p-8 bg-white rounded-[2.5rem] border-2 border-rose-100 shadow-2xl space-y-6">
                      ...
                      <button onClick={() => startProcessing()} disabled={!password}
            ...
            {status === 'completed' && (
              <div className="text-center w-full max-w-2xl animate-in fade-in slide-in-from-bottom-8 duration-500">
                ...
                <h1 className="text-4xl md:text-5xl font-black text-gray-900 mb-3 tracking-tight">Protected!</h1>
                <div className="bg-white p-5 md:p-8 rounded-[2.5rem] shadow-xl border border-gray-50 flex flex-col items-center gap-6">
                  <button onClick={handleDownload}
                    ...
                    <Download size={28} /> DOWNLOAD PROTECTED PDF
                  </button>
