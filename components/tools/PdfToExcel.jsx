...
const config = TOOLS_CONFIG['pdf-to-excel'];  // ← 1. slug
const COLOR = 'rose-600';                    // ← 2. color
const BTN_TEXT = 'Select PDF File';           // ← 3. button text
const DL_TEXT = 'DOWNLOAD EXCEL FILE';        // ← 4. download text
