...
const FAQ_ITEMS = [
  {
    q: 'How do I convert PDF to Excel for free?',
    a: "Upload your PDF file to FreePDFConvert's free PDF to Excel converter, click Convert, and download your XLSX file instantly. No signup or software installation required."
  },
  {
    q: 'Does it extract tables correctly from the PDF?',
    a: 'Yes. The converter identifies tables, rows, and columns in your PDF and maps them accurately into Excel cells so data is ready to edit or analyze.'
  },
  {
    q: 'Will the converted Excel file have a watermark?',
    a: 'No. FreePDFConvert never adds watermarks to any converted file. Your XLSX output is always completely clean.'
  },
  {
    q: 'What Excel format is the output file?',
    a: 'The output is an XLSX file, which is compatible with Microsoft Excel 2007 and later, Google Sheets, LibreOffice Calc, and all modern spreadsheet applications.'
  },
  {
        ...
        >
            ...
            <article className="w-full max-w-4xl flex flex-col items-center animate-in fade-in slide-in-from-top-4 duration-700">
              ...
              >
                <label 
                  ...
                  aria-label="Select a PDF document to parse"
                >
          ...
          {(status === 'uploading' || status === 'processing') && (
            <div 
              ...
              role="status"
              aria-live="polite"
              aria-label={status === 'uploading' ? 'Uploading PDF file' : 'Converting to spreadsheet format'}
            >
              ...
              <div 
                ...
                aria-label="Conversion pipeline state"
              >
                <div
          ...
          {status === 'completed' && (
            <div 
              ...
              role="status"
              aria-live="polite"
              aria-label="Conversion workflow complete. Spreadsheet file ready for download."
            >
              ...
              <div className="bg-white p-5 md:p-8 rounded-[2.5rem] shadow-xl border border-gray-50 flex flex-col items-center gap-6">
                <button
                  ...
                  aria-label="Download converted Excel spreadsheet"
                >
                ...
                <button 
                  ...
                  aria-label="Convert another file step resetting queue"
                >
