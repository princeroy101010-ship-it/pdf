...
export const TOOLS_CONFIG = {
  ...
  "pdf-to-word": {
    ...
    seo: {
      ...
      og_title: "Free PDF to Word Converter – No Signup ",
  ...
  "png-to-pdf": {
    slug: "png-to-pdf",
    seo: {
      title: "PNG to PDF Converter – Free Online ",
  ...
  "Text-to-pdf": {
    slug: "Text-to-pdf",
    seo: {
      title: "Text to PDF Converter – Free Online ",
  ...
  "Text-to-word": {
    slug: "Text-to-word",
    seo: {
      title: "Text to Word Converter – Free Online ",
  ...
  "word-to-Text": {
    slug: "word-to-Text",
    seo: {
      title: "Word to Text Converter – Free Online ",
  ...
  "pptx-to-Text": {
    slug: "pptx-to-Text",
    seo: {
      title: "PowerPoint to Text – Extract Text from PPT Free ",
  ...
  "Text-to-pptx": {
    slug: "Text-to-pptx",
    seo: {
      title: "Text to PowerPoint Converter – Free Online ",
  ...
  "pdf-to-html": {
    slug: "pdf-to-html",
    seo: {
      title: "PDF to HTML Converter – Free Online ",
  ...
  "extract-text-from-pdf": {
    ...
    seo: {
      title: "Extract Text from PDF – Free Online OCR ",
...
export const generateSchemas = (config, baseUrl = "https://www.freepdfconvert.io") => {
...
offers: {
  ...
  ratingCount: rating.reviewCount,   // ← change reviewCount → ratingCount
