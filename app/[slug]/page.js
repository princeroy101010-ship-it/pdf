...
const TOOL_SEO = {
  ...
  "image-to-pdf": { 
    title: "Image to PDF Converter – JPG & PNG to PDF | FreePDFConvert", 
    description: "Convert JPG, PNG, BMP and more to PDF online. Combine multiple images into one PDF easily.", 
    h1: "Image to PDF Converter", 
    subtitle: "Turn your photos and images into professional PDF documents in seconds.", 
...
const isImageTool = toolSlug === 'image-to-pdf' || toolSlug === 'jpg-to-pdf' || toolSlug === 'png-to-pdf';
  const getAcceptedFiles = () => {
    if (isImageTool) return "image/jpeg,image/jpg,image/png";
