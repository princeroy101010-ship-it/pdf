      ...
      <header className="bg-white  py-20 px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-400 font-medium">
            Please read these terms carefully before using VIP-PDF tools.
          </p>
        </div>
      </header>
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-16 w-full">
        ...
        <div className="bg-gray-900 rounded-[2.5rem] p-10 mb-12 text-white relative overflow-hidden shadow-2xl">
          ...
          <p className="text-gray-400 font-medium leading-relaxed">
            By accessing or using VIP-PDF, you agree to be bound by these Terms of Service. If you do not agree with any part of these terms, you may not use our services.
          </p>
        </div>

        {/* Terms Sections */}
        <TermCard icon={ShieldAlert} title="1. Usage License">
          <p>We grant you a personal, non-exclusive, non-transferable license to use VIP-PDF for your personal or business document processing needs.</p>
        ...
        <TermCard icon={Ban} title="2. Prohibited Content">
          <p>You are solely responsible for the content you upload. You agree not to use VIP-PDF to process:</p>
        ...
        <TermCard icon={FileWarning} title="3. Limitation of Liability">
          <p>VIP-PDF provides tools "as is" without any warranties. While we strive for 100% uptime and accuracy:</p>
        ...
        <TermCard icon={Files} title="4. Service Modifications">
          <p>We reserve the right to modify or discontinue any part of the service (free or paid) at any time without prior notice. We may also update these terms periodically to reflect changes in our service or law.</p>
        </TermCard>

        {/* Footer Note */}
        <div className="text-center py-10 border-t border-gray-200">
          <p className="text-gray-400 text-sm font-bold uppercase tracking-widest">
            Questions? Contact us at <span className="text-rose-600">legal@vip-pdf.com</span>
          </p>
        </div>
      </main>
