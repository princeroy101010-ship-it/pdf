...
export const metadata = {
  title: "Why Choose FreePDFConvert – Fast, Secure & Free PDF Tools",
  description:
    "Discover what makes FreePDFConvert different. Lightning fast processing, AI optimization, mobile-first design, and 100% privacy. Free PDF tools with no signup.",
  alternates: {
    canonical: "https://freepdfconvert.io/features",
  },
  openGraph: {
    title: "Why Choose FreePDFConvert – The Best Free PDF Tool Online",
    description:
      "Fast servers, AI compression, mobile-first design and zero data storage. See why millions choose FreePDFConvert.",
    url: "https://freepdfconvert.io/features",
    type: "website",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "FreePDFConvert – Why Choose Us" }],
    locale: "en_US",
  ...
  twitter: {
    ...
    description: "AI-powered PDF tools. Lightning fast, mobile-first, zero data stored. Free forever.",
    images: ["/og-image.png"],
  },
  robots: "index, follow",
};
...
const WhyChooseUs = () => {
  const features = [
    ...
    { icon: Smartphone, title: "Mobile First",     desc: "Whether you're on iPhone or Android, FreePDFConvert works flawlessly on every screen size." },
