...
import { Cookie, ShieldCheck, Settings, Info, MousePointer2, Files } from 'lucide-react';
      ...
      <header className="bg-white  py-20 px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-400 font-medium max-w-2xl mx-auto">
            Transparent information about how we use cookies to improve your VIP-PDF experience.
          </p>
        </div>
      </header>
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-16 w-full">
        ...
        <div className="bg-rose-600 rounded-[2.5rem] p-10 mb-12 text-white shadow-xl shadow-rose-100 relative overflow-hidden">
          ...
          <p className="text-rose-50 text-lg font-medium leading-relaxed relative z-10">
            Cookies are small text files stored on your device. They help us remember your settings (like language or tool preferences) and ensure the website works smoothly.
          </p>
        </div>

        {/* Sections */}
        <CookieSection icon={ShieldCheck} title="How We Use Cookies">
          <p>At VIP-PDF, we use cookies for very specific reasons:</p>
          <ul className="list-disc pl-5 space-y-2">
            <li><strong>Essential Cookies:</strong> Required for the website to function (e.g., handling file uploads).</li>
            <li><strong>Preference Cookies:</strong> To remember your choices like dark mode or tool layouts.</li>
        ...
        <CookieSection icon={Settings} title="Managing Your Cookies">
          <p>Most browsers allow you to control cookies through their settings. You can block or delete cookies, but keep in mind that some parts of VIP-PDF might not work correctly if you disable essential cookies.</p>
        ...
        <CookieSection icon={MousePointer2} title="Third-Party Cookies">
          <p>We may use third-party services like Google Analytics to track website performance. These services set their own cookies to collect anonymous data about your visit.</p>
        </CookieSection>

        {/* Final Consent Note */}
        <div className="text-center py-12">
          <p className="text-gray-400 text-sm font-bold uppercase tracking-widest mb-4">
            By using VIP-PDF, you consent to our use of cookies.
          </p>
